...
max_upload_date  = MIN_DATE + (60 * 60 * 24) - 1
search_url = "services/rest/"

$stderr.printf("min_upload:%s max_upload:%s\n", min_upload_date, max_upload_date)
while min_upload_date < MAX_DATE
  ...
  while photos_to_retrieve > 0
    url_params = {:method => "flickr.photos.search",
      ...
      :sort => "date-taken-asc", 
      :page => page.to_s,
      :min_upload_date => min_upload_date.to_i.to_s,
      :max_upload_date => max_upload_date.to_i.to_s 
    }
  ...
  min_upload_date += (60 * 60 * 24)
  max_upload_date += (60 * 60 * 24)
end
